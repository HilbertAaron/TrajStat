    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jPanel_SelFields, javax.swing.GroupLayout.PREFERRED_SIZE, 221, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addComponent(jPanel_FieldProp, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jButton_AddData)
                    .addComponent(jButton_Cancel))
    ...
    private void jButton_AddDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_AddDataActionPerformed
        ...
        try {
            ...
            if (eDateFldIdx == 0) {
                ...
                eDateFldIdx -= 1;
                //Read data                
                List<Object[]> myDataList = new ArrayList<Object[]>();
                sr = new BufferedReader(new FileReader(infile));
                String aDataStr;
                String[] aDataArray;
                int N = 0;
